// $ANTLR 3.4 ShellCommand.g 2018-01-14 13:52:13
...
public class ShellCommandLexer extends Lexer {
    ...
    public final void mWS() throws RecognitionException {
        try {
            int _type = WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ShellCommand.g:1561:3: ( ( ' ' | '\\t' | '\\f' | NEWLINE ) )
            // ShellCommand.g:1562:5: ( ' ' | '\\t' | '\\f' | NEWLINE )
            {
            // ShellCommand.g:1562:5: ( ' ' | '\\t' | '\\f' | NEWLINE )
            int alt1=4;
            switch ( input.LA(1) ) {
    ...
    public final void mSL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ShellCommand.g:1571:11: ( ( '//' | '--' ) (~ ( NEWLINE ) )* )
            // ShellCommand.g:1572:5: ( '//' | '--' ) (~ ( NEWLINE ) )*
            {
            // ShellCommand.g:1572:5: ( '//' | '--' )
            int alt2=2;
    ...
    public final void mML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ShellCommand.g:1578:11: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // ShellCommand.g:1579:5: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); if (state.failed) return ;



            // ShellCommand.g:1579:10: ( options {greedy=false; } : . )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mARROW() throws RecognitionException {
        try {
            int _type = ARROW;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ShellCommand.g:1586:10: ( '->' )
            // ShellCommand.g:1586:12: '->'
            {
            match("->"); if (state.failed) return ;
    ...
    public final void mAT() throws RecognitionException {
        try {
            int _type = AT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ShellCommand.g:1587:11: ( '@' )
            // ShellCommand.g:1587:13: '@'
            {
            match('@'); if (state.failed) return ;
    ...
    public final void mBAR() throws RecognitionException {
        try {
            int _type = BAR;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ShellCommand.g:1588:8: ( '|' )
            // ShellCommand.g:1588:10: '|'
            {
            match('|'); if (state.failed) return ;
    ...
    public final void mCOLON_COLON() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ShellCommand.g:1590:14: ( '::' )
            // ShellCommand.g:1590:16: '::'
            {
            match("::"); if (state.failed) return ;
    ...
    public final void mCOMMA() throws RecognitionException {
        try {
            int _type = COMMA;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ShellCommand.g:1592:10: ( ',' )
            // ShellCommand.g:1592:12: ','
            {
            match(','); if (state.failed) return ;
    ...
    public final void mDOTDOT() throws RecognitionException {
        try {
            int _type = DOTDOT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ShellCommand.g:1594:11: ( '..' )
            // ShellCommand.g:1594:13: '..'
            {
            match(".."); if (state.failed) return ;
    ...
    public final void mEQUAL() throws RecognitionException {
        try {
            int _type = EQUAL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ShellCommand.g:1595:10: ( '=' )
            // ShellCommand.g:1595:12: '='
            {
            match('='); if (state.failed) return ;
    ...
    public final void mGREATER() throws RecognitionException {
        try {
            int _type = GREATER;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ShellCommand.g:1596:11: ( '>' )
            // ShellCommand.g:1596:13: '>'
            {
            match('>'); if (state.failed) return ;
    ...
    public final void mGREATER_EQUAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ShellCommand.g:1597:15: ( '>=' )
            // ShellCommand.g:1597:17: '>='
            {
            match(">="); if (state.failed) return ;
    ...
    public final void mHASH() throws RecognitionException {
        try {
            int _type = HASH;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ShellCommand.g:1598:9: ( '#' )
            // ShellCommand.g:1598:11: '#'
            {
            match('#'); if (state.failed) return ;
    ...
    public final void mLESS_EQUAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ShellCommand.g:1602:14: ( '<=' )
            // ShellCommand.g:1602:16: '<='
            {
            match("<="); if (state.failed) return ;
    ...
    public final void mLPAREN() throws RecognitionException {
        try {
            int _type = LPAREN;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ShellCommand.g:1603:11: ( '(' )
            // ShellCommand.g:1603:13: '('
            {
            match('('); if (state.failed) return ;
    ...
    public final void mMINUS() throws RecognitionException {
        try {
            int _type = MINUS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ShellCommand.g:1604:10: ( '-' )
            // ShellCommand.g:1604:12: '-'
            {
            match('-'); if (state.failed) return ;
    ...
    public final void mNOT_EQUAL() throws RecognitionException {
        try {
            int _type = NOT_EQUAL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ShellCommand.g:1605:13: ( '<>' )
            // ShellCommand.g:1605:15: '<>'
            {
            match("<>"); if (state.failed) return ;
    ...
    public final void mPLUS() throws RecognitionException {
        try {
            int _type = PLUS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ShellCommand.g:1606:9: ( '+' )
            // ShellCommand.g:1606:11: '+'
            {
            match('+'); if (state.failed) return ;
    ...
    public final void mRPAREN() throws RecognitionException {
        try {
            int _type = RPAREN;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ShellCommand.g:1609:10: ( ')' )
            // ShellCommand.g:1609:12: ')'
            {
            match(')'); if (state.failed) return ;
    ...
    public final void mSTAR() throws RecognitionException {
        try {
            int _type = STAR;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ShellCommand.g:1612:9: ( '*' )
            // ShellCommand.g:1612:11: '*'
            {
            match('*'); if (state.failed) return ;
    ...
    public final void mINT() throws RecognitionException {
        try {
            // ShellCommand.g:1616:4: ( ( '0' .. '9' )+ )
            // ShellCommand.g:1617:5: ( '0' .. '9' )+
            {
            // ShellCommand.g:1617:5: ( '0' .. '9' )+
            int cnt6=0;
            loop6:
    ...
    public final void mREAL() throws RecognitionException {
        try {
            // ShellCommand.g:1621:5: ( INT ( '.' INT ( ( 'e' | 'E' ) ( '+' | '-' )? INT )? | ( 'e' | 'E' ) ( '+' | '-' )? INT ) )
            // ShellCommand.g:1622:5: INT ( '.' INT ( ( 'e' | 'E' ) ( '+' | '-' )? INT )? | ( 'e' | 'E' ) ( '+' | '-' )? INT )
            {
            mINT(); if (state.failed) return ;


            // ShellCommand.g:1622:9: ( '.' INT ( ( 'e' | 'E' ) ( '+' | '-' )? INT )? | ( 'e' | 'E' ) ( '+' | '-' )? INT )
            int alt10=2;
            ...
            switch (alt10) {
                case 1 :
                    // ShellCommand.g:1622:10: '.' INT ( ( 'e' | 'E' ) ( '+' | '-' )? INT )?
                    {
                    match('.'); if (state.failed) return ;
                    ...
                    // ShellCommand.g:1622:18: ( ( 'e' | 'E' ) ( '+' | '-' )? INT )?
                    int alt8=2;
                    ...
                    switch (alt8) {
                        case 1 :
                            // ShellCommand.g:1622:19: ( 'e' | 'E' ) ( '+' | '-' )? INT
                            {
                    ...
                    break;
                case 2 :
                    // ShellCommand.g:1622:52: ( 'e' | 'E' ) ( '+' | '-' )? INT
                    {
                    if ( input.LA(1)=='E'||input.LA(1)=='e' ) {
                        input.consume();
                        state.failed=false;
    ...
    public final void mRANGE_OR_INT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ShellCommand.g:1624:13: ( ( INT '..' )=> INT | ( REAL )=> REAL | INT )
            int alt11=3;
            ...
            switch (alt11) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // ShellCommand.g:1626:7: ( REAL )=> REAL
                    {
    ...
    public final void mSTRING() throws RecognitionException {
        try {
            int _type = STRING;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ShellCommand.g:1631:7: ( '\\'' (~ ( '\\'' | '\\\\' ) | ESC )* '\\'' )
            // ShellCommand.g:1632:5: '\\'' (~ ( '\\'' | '\\\\' ) | ESC )* '\\''
            {
            match('\''); if (state.failed) return ;

            // ShellCommand.g:1632:10: (~ ( '\\'' | '\\\\' ) | ESC )*
            loop12:
            do {
                int alt12=3;
    ...
    public final void mNON_OCL_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ShellCommand.g:1634:15: ( '\"' (~ ( '\"' | '\\\\' ) | ESC )* '\"' )
            // ShellCommand.g:1635:5: '\"' (~ ( '\"' | '\\\\' ) | ESC )* '\"'
            {
            match('\"'); if (state.failed) return ;

            // ShellCommand.g:1635:9: (~ ( '\"' | '\\\\' ) | ESC )*
            loop13:
            do {
                int alt13=3;
    ...
    public final void mESC() throws RecognitionException {
        try {
            // ShellCommand.g:1648:5: ( '\\\\' ( 'n' | 'r' | 't' | 'b' | 'f' | '\"' | '\\'' | '\\\\' | 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | '0' .. '3' ( '0' .. '7' ( '0' .. '7' )? )? | '4' .. '7' ( '0' .. '7' )? ) )
            // ShellCommand.g:1649:5: '\\\\' ( 'n' | 'r' | 't' | 'b' | 'f' | '\"' | '\\'' | '\\\\' | 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | '0' .. '3' ( '0' .. '7' ( '0' .. '7' )? )? | '4' .. '7' ( '0' .. '7' )? )
            {
            match('\\'); if (state.failed) return ;

            // ShellCommand.g:1650:6: ( 'n' | 'r' | 't' | 'b' | 'f' | '\"' | '\\'' | '\\\\' | 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | '0' .. '3' ( '0' .. '7' ( '0' .. '7' )? )? | '4' .. '7' ( '0' .. '7' )? )
            int alt17=11;
            switch ( input.LA(1) ) {
            case 'n':
                {
            ...
            switch (alt17) {
                ...
                case 8 :
                    ...
                    break;
                case 9 :
                    // ShellCommand.g:1658:8: 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT
                    {
                    ...
                    break;
                case 10 :
                    // ShellCommand.g:1659:8: '0' .. '3' ( '0' .. '7' ( '0' .. '7' )? )?
                    {
                    matchRange('0','3'); if (state.failed) return ;

                    // ShellCommand.g:1659:17: ( '0' .. '7' ( '0' .. '7' )? )?
                    int alt15=2;
                    ...
                    switch (alt15) {
                        case 1 :
                            // ShellCommand.g:1659:18: '0' .. '7' ( '0' .. '7' )?
                            {
                            matchRange('0','7'); if (state.failed) return ;

                            // ShellCommand.g:1659:27: ( '0' .. '7' )?
                            int alt14=2;
                    ...
                    break;
                case 11 :
                    // ShellCommand.g:1659:45: '4' .. '7' ( '0' .. '7' )?
                    {
                    matchRange('4','7'); if (state.failed) return ;

                    // ShellCommand.g:1659:54: ( '0' .. '7' )?
                    int alt16=2;
    ...
    public final void mHEX_DIGIT() throws RecognitionException {
        try {
            // ShellCommand.g:1665:10: ( ( '0' .. '9' | 'A' .. 'F' | 'a' .. 'f' ) )
            // ShellCommand.g:
            {
    ...
    public final void mIDENT() throws RecognitionException {
        try {
            int _type = IDENT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ShellCommand.g:1672:6: ( ( '$' | 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // ShellCommand.g:1673:5: ( '$' | 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            ...
            // ShellCommand.g:1673:39: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop18:
            do {
                int alt18=2;
    ...
    public final void synpred1_ShellCommand_fragment() throws RecognitionException {
        // ShellCommand.g:1625:7: ( INT '..' )
        // ShellCommand.g:1625:9: INT '..'
        {
        mINT(); if (state.failed) return ;
    ...
    public final void synpred2_ShellCommand_fragment() throws RecognitionException {
        // ShellCommand.g:1626:7: ( REAL )
        // ShellCommand.g:1626:9: REAL
        {
        mREAL(); if (state.failed) return ;
